/**
 * Decorative SVG graphics for the auth pages (login / signup).
 * Pulled from the reference "Form" component, kept pixel-identical.
 * Pure presentational — no props, no state.
 */

export function AuthRaysGlow() {
  return (
    <svg
      fill="none"
      viewBox="0 0 299 152"
...
export function AuthEmitterGlow() {
  return (
    <svg
      fill="none"
      viewBox="0 0 160 61"
